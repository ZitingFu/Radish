...
//			}
		...
		_GenerateHtmlUnit: function(status, src, id, msg){
			...
			var loadedTpl = '<tr data-src="{src}" class="file-uploaded fl1">\
							<td class="radio-paly"><img src="{src}"></td>\
							<td>\
								<p>已上传</p>\
							</td>\
							<td>\
								<input type="hidden" name="{name}" value="{src}" class="file-uploaded-input aaa1I">\
                <label class="collapse file-uploaded-input-data aaa1L">{src-data}</label>\
