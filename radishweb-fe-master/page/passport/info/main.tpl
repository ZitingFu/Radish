...
<div class="wrapper p-t30 paddingLg">
    <div class="content w-930 pull-right wrap-content section w-baifen80">
        <div class="titlebar m-t0 m-b20">
            <label>个人中心</label>&nbsp;&nbsp;
            <a href="/radishweb/passport/balance?type=1" class="love_active">余额账户&nbsp;</a><b class="lineI"></b>
            <a href="/radishweb/passport/lovelist?type=1" class="love_active">爱心值&nbsp;{$pass.love}</a><b class="lineI"></b>
            <a href="/radishweb/question/stat">发布数&nbsp;{$pass.issue_num}</a><b class="lineI"></b>
            <a href="/radishweb/question/foundlist">已找到&nbsp;{$pass.found_num}</a></b>
        </div>
        <div class="col-list m-t20">
            <form id="form-edit">
                <ul class="clearFix w-400" style="height:400px;">
                    ...
                    <li class="form-group">
                        ...
                        <select id="select_year"  class="form-control m-l3 m-r10" rel="{$pass.birthday|date_format:'%Y'}" style=" width: 100px;"></select>  <!--年设置rel 可以设置默认的年月日-->
                    ...
                    <li class="form-group"> <button type="button" class="btn btn-warning btn-primary m-l78 w-192" style="width: 224px;height: 40px;">保存</button><label class="p-w25"></label> </li>
                </ul>
            </form>
        </div>
    </div>
