...
{include file="radishweb/widgets/header/header.tpl"}
 ...
 <div class="wrapper p-t30 paddingLg" style="overflow: hidden;">
	<div class="Survey-head">
		<h2>
			<a class="aorange" href="/radishweb/subaccount/index">子账号管理</a>
			<i class="Y"></i>
			<a class="aorange orange1" href="/radishweb/subaccount/create">添加子账号</a>
		</h2>
		<div class="Survey">
				<form action="" id="form">
					<div class="form-group form-tel">
						<label for="tel" class="control-label">填写子账号</label>
						<label for="tel">
							<input id="tel" type="text" name="" class="form-control compony_account" autocomplete="off">
						</label>
						<label for="tel">
					...
					<div class="form-group form-pw">
						<label for="pw" class="control-label">填写子账号名称</label>
						<label for="tel">
							<input id="tel" type="text" name="" class="form-control compony_name" autocomplete="off">
						</label>
						<label for="tel">
					...
					<div class="form-group form-name">
						<label for="name" class="control-label ">填写登录密码</label>
						<label for="tel">
							<input id="tel" type="password" name="" class="form-control compony_password">
						</label>	
						<label for="tel">
				...
				<p>
					<button class="btn btn-warning confirm" style="width:193px;line-height:19px;font-size: 17px">提交</button>
				</p>
		</div>
	</div>
